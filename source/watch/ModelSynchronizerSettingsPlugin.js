 ...
 * @ignore
 */
const ModelSynchronizerDataPlugin = require('./ModelSynchronizerDataPlugin.js')
...
class ModelSynchronizerSettingsPlugin extends ModelSynchronizerDataPlugin {
    ...
    constructor(cliLogger, sitesRepository, settingsRepository, pathesConfiguration) {
        super(
            cliLogger.createPrefixed('modelsynchronizer.settings'),
            sitesRepository,
            settingsRepository,
            pathesConfiguration
        );
    ...
    static get injections() {
        return {
            parameters: [CliLogger, SitesRepository, SettingsRepository, PathesConfiguration]
        };
    }
