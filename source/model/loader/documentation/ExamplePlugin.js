...
const PathesConfiguration = require('../../configuration/PathesConfiguration.js')
    .PathesConfiguration;
const ExampleFileParser = require('../../../parser/documentation/ExampleFileParser.js')
    .ExampleFileParser;
...
class ExamplePlugin extends ParserPlugin {
    ...
    static get injections() {
        return {
            parameters: [PathesConfiguration, 'model.loader.documentation/ExamplePlugin.options']
        };
    }
