...
const PathesConfiguration = require('../../configuration/PathesConfiguration.js')
    .PathesConfiguration;
const MarkdownFileParser = require('../../../parser/documentation/MarkdownFileParser.js')
    .MarkdownFileParser;
...
class MarkdownPlugin extends ParserPlugin {
    ...
    static get injections() {
        return {
            parameters: [PathesConfiguration, 'model.loader.documentation/MarkdownPlugin.options']
        };
    }
