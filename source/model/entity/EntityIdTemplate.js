...
class EntityIdTemplate extends Base {
    ...
    constructor(idParser, options) {
        ...
        // Precompile
        this._templates = {};
        this._templates[IdParser.TEMPLATE_CATEGORY] = compile(
            this._idParser.getTemplate(IdParser.TEMPLATE_CATEGORY)
        );
        this._templates[IdParser.TEMPLATE_ID] = compile(
            this._idParser.getTemplate(IdParser.TEMPLATE_ID)
        );
        this._templates[IdParser.TEMPLATE_CATEGORY_PATH] = compile(
            this._idParser.getTemplate(IdParser.TEMPLATE_CATEGORY_PATH)
        );
        this._templates[IdParser.TEMPLATE_ID_PATH] = compile(
            this._idParser.getTemplate(IdParser.TEMPLATE_ID_PATH)
        );
    }
