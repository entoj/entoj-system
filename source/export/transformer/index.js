 ...
 */
module.exports = {
    DecorateVariableNameTransformer: require('./DecorateVariableNameTransformer.js')
        .DecorateVariableNameTransformer,
    InlineMacroCallTransformer: require('./InlineMacroCallTransformer.js')
    ...
    RemoveLoadModelTransformer: require('./RemoveLoadModelTransformer.js')
