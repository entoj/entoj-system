    ...
    const promise = co(function*()
    {
        ...
        if (macroConfiguration.parameters)
        {
            for (const parameter in macroConfiguration.parameters)
            {
                ...
                const type = result[parameter].type
                    ? result[parameter].type
                    : [];
                const name = typeof macroConfiguration.parameters[parameter] === 'object'
                    ? macroConfiguration.parameters[parameter].name
                    : parameter;
                const value = typeof macroConfiguration.parameters[parameter] === 'object'
