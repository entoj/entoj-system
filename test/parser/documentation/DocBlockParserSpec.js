...
const DocBlockParser = require(ES_SOURCE + '/parser/documentation/DocBlockParser.js')
    .DocBlockParser;
...
const DocumentationCompoundParameter = require(ES_SOURCE +
    '/model/documentation/DocumentationCompoundParameter.js').DocumentationCompoundParameter;
    ...
    describe('#parse()', function() {
        it('should resolve to a DocumentationCode by default', function() {
            ...
            const promise = testee
                .parse(docblock, { contentType: ContentType.JINJA })
        ...
        it('should allow to force a result type via the hint option', function() {
            ...
            #}`;
            const promise = testee
                .parse(docblock, { contentType: ContentType.JINJA, hint: 'callable' })
                .then(function(documentation) {
        ...
        it('should resolve to a DocumentationCallable when finding a @kind function', function() {
             ...
             */`;
            const promise = testee
                .parse(docblock, { contentType: ContentType.SASS })
                .then(function(documentation) {
                    expect(documentation).to.be.instanceof(DocumentationCallable);
                });
            return promise;
        ...
        it('should resolve to a DocumentationClass when finding a @class', function() {
             ...
             */`;
            const promise = testee
                .parse(docblock, { contentType: ContentType.JS })
                .then(function(documentation) {
        ...
        describe('should parse @param tags', function() {
            it('should allow a param to have a name', function() {
                ...
                const promise = testee
                    .parse(docblock, { contentType: ContentType.JINJA })
                    .then(function(documentation) {
                        const param = documentation.parameters.find(
