 ...
 * Requirements
 */
const MapParametersTransformer = require(ES_SOURCE + '/export/transformer/MapParametersTransformer.js').MapParametersTransformer;
...
describe(MapParametersTransformer.className, function()
{
    ...
    nodeTransformerSpec(MapParametersTransformer, 'export.transformer/MapParametersTransformer', undefined, undefined, options);
    ...
    describe('#transform()', function()
    {
        it('should rename all mapped parameters', function()
        {
            const promise = co(function*()
            {
                ...
                const node = yield exportHelper.loadInputFixture('MapParametersTransformer.input.j2', 'ast');
