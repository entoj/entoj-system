 ...
 * Requirements
 */
const ModelSynchronizerDataPlugin = require(ES_SOURCE + '/watch/ModelSynchronizerDataPlugin.js')
...
describe(ModelSynchronizerDataPlugin.className, function() {
     ...
     */
    dataPluginSpec(ModelSynchronizerDataPlugin, 'watch/ModelSynchronizerDataPlugin', function(
        parameters,
        fileTemplate
    ) {
