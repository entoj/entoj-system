 ...
 * Requirements
 */
const ModelSynchronizerSettingsPlugin = require(ES_SOURCE + '/watch/ModelSynchronizerSettingsPlugin.js').ModelSynchronizerSettingsPlugin;
...
describe(ModelSynchronizerSettingsPlugin.className, function()
{
     ...
     */
    dataPluginSpec(ModelSynchronizerSettingsPlugin, 'watch/ModelSynchronizerSettingsPlugin', function(parameters, fileTemplate)
    {
        const fixture = projectFixture.createDynamic();
        const dataLoader = new SettingsLoader(fixture.sitesRepository, fixture.pathesConfiguration, fileTemplate);
