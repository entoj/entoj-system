...
describe('utils/glob', function() {
    ...
    describe('#glob', function() {
        it('should return a promise', function() {
            const pathes =
                global.fixtures.root + PATH_SEPERATOR + 'mixed' + PATH_SEPERATOR + '*.j2';
        ...
        it('should glob all files in multiple directories', function(cb) {
            ...
            const pathes = [
                path + PATH_SEPERATOR + 'j2' + PATH_SEPERATOR + '*.j2',
            ...
            glob(pathes)
                .then((files) => {
                    ...
                    expect(files).to.contain(
                        path + PATH_SEPERATOR + 'j2' + PATH_SEPERATOR + 'j2-01.j2'
                    );
                    expect(files).to.contain(
                        path + PATH_SEPERATOR + 'mixed' + PATH_SEPERATOR + 'mixed-j2-01.j2'
                    );
                    cb();
                })
                .catch((e) => cb(e));
