...
const ViewModelLipsumHtmlPlugin = require(ES_SOURCE + '/model/viewmodel/plugin/ViewModelLipsumHtmlPlugin.js').ViewModelLipsumHtmlPlugin;
...
describe(ViewModelLipsumHtmlPlugin.className, function()
{
     ...
     * Base Test
     */
    viewModelPluginSpec(ViewModelLipsumHtmlPlugin, 'model.viewmodel.plugin/ViewModelLipsumHtmlPlugin');
    ...
    describe('#execute', function()
    {
        ...
        describe('staticContent=true', function()
        {
            it('should generate a static lipsum text', function()
            {
                ...
                {
                    const testee = new ViewModelLipsumHtmlPlugin();
                    const result1 = yield testee.execute(global.fixtures.viewModelRepository,
                        global.fixtures.siteBase,
                        true,
                        'lipsum-html',
                        '');
                    const result2 = yield testee.execute(global.fixtures.viewModelRepository,
                        global.fixtures.siteBase,
                        true,
                        'lipsum-html',
                        '');
